...
class BaseVendasRealizadas(models.Model):
    ...
    seguro_2 = models.DecimalField(max_digits=7, decimal_places=2)
    outras_desp_2 = models.DecimalField(max_digits=7, decimal_places=2)
    valor_ipi_2 = models.DecimalField(max_digits=7, decimal_places=2)
    notal_nf_2 = models.DecimalField(max_digits=7, decimal_places=2)
    valor_icms_2 = models.DecimalField(max_digits=7, decimal_places=2)
    valor_pis_2 = models.DecimalField(max_digits=7, decimal_places=2)
    valor_cofins_2 = models.DecimalField(max_digits=7, decimal_places=2)
    classificacao_resultado_faturamento_2 = models.CharField(max_length=240)
    data_faturamento_2 = models.DateField()
    valor_cmv_unit_2 = models.DecimalField(max_digits=7, decimal_places=2)
    valor_cmv_total_2 = models.DecimalField(max_digits=7, decimal_places=2)
