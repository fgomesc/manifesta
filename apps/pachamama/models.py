...
class BaseVendasRealizadas(models.Model):
    ...
    pedido_vendas_2 = models.DecimalField(max_digits=1000, decimal_places=2)
    ...
    quantidade_2 = models.DecimalField(max_digits=1000, decimal_places=2)
    total_mercadoria_2 = models.DecimalField(max_digits=1000, decimal_places=2)
    desconto_2 = models.DecimalField(max_digits=1000, decimal_places=2)
    valor_icms_st_2 = models.DecimalField(max_digits=1000, decimal_places=2)
    frete_2 = models.DecimalField(max_digits=1000, decimal_places=2)
    seguro_2 = models.DecimalField(max_digits=1000, decimal_places=2)
    outras_desp_2 = models.DecimalField(max_digits=1000, decimal_places=2)
    valor_ipi_2 = models.DecimalField(max_digits=1000, decimal_places=2)
    notal_nf_2 = models.DecimalField(max_digits=1000, decimal_places=2)
    valor_icms_2 = models.DecimalField(max_digits=1000, decimal_places=2)
    valor_pis_2 = models.DecimalField(max_digits=1000, decimal_places=2)
    valor_cofins_2 = models.DecimalField(max_digits=1000, decimal_places=2)
